...
import { registerElement, defineLazyScopedElement } from '../src/registerElement.js';
...
describe('defineLazyElement', () => {
  it('should allow the use of lazy elements', async () => {
    ...
    defineLazyScopedElement('naboo-planet', Naboo, tagsCache);
